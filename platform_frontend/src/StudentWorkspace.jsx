...
import { api, date, PLATFORM_URL, TOOLS } from "./api";
        ...
        <section className="chat-panel" aria-label={`${tool.name} assignment`}>
          ...
          {assignment.tool === "reflections" ? (
            <div className="start-state">
              ...
              <a className="button" href={`${PLATFORM_URL}reflections.html?assignment=${encodeURIComponent(id)}`} target="_blank" rel="noopener noreferrer">
